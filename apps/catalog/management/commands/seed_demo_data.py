...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        admin_user.email = admin_user.email or "admin@pcnest.local"
        ...
        demo_user, _ = User.objects.get_or_create(
            username="demo",
            defaults={
                "email": "demo@pcnest.local",
                "role": User.Role.USER,
            },
        )
        demo_user.role = User.Role.USER
        demo_user.email = demo_user.email or "demo@pcnest.local"
